...
class MyRobot:
    ...
    def __init__(self):
        ...
        self.joint_publisher=rospy.Publisher('/joint1',geometry_msgs.msg.Quaternion,queue_size=10)
    ...
    def print_joint_angle_values(self):
        ...
        quaternion_list = ['2','3','4','5']
	
        self.joint_publisher.publish(quaternion_list)
         #Print the values
        rospy.loginfo('\033[32m' + "\nArm Joint Values: \n\n" +
